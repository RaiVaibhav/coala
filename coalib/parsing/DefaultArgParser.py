...
"""
    ...
    devtool_exclusive_group.add_argument(
        ...
        ' already existing file a error is thrown. All bears (even implicit'
        ' dependency bears) in a section will be profiled. Profiled data files'
        ' will have a name format ``{section.name}_{bear.name}.prof``.')
